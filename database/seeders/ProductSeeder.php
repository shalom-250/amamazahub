    ...
    public function run(): void
    {
        $products = [
            [
                ...
                'colors' => json_encode(['Titanium Black', 'Frost White', 'Sunset Orange']),
                'rating' => 4.9,
                'reviews_count' => 1243,
                'is_bestseller' => true,
            ],
            [
                ...
                'colors' => json_encode(['Matte Black', 'Silver']),
                'rating' => 4.8,
                'reviews_count' => 512,
                'is_bestseller' => false,
            ],
            [
                ...
                'colors' => json_encode(['Black/Red', 'Stealth Black']),
                'rating' => 4.7,
                'reviews_count' => 890,
                'is_bestseller' => true,
            ],
            [
                ...
                'colors' => json_encode(['Cyber Neon', 'Aqua Blue']),
                'rating' => 4.5,
                'reviews_count' => 3200,
                'is_bestseller' => true,
            ],
